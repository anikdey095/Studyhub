...
const FEATURED_NOTES = [
  ...
  },
  {
    ...
    desc: 'Self-attention math, multi-head transformers, and practical GPU training workflows.',
  ...
  {
    id: 'note-3',
    title: 'Organic Synthesis Reaction Mechanisms & Spectrometry',
    desc: 'High-yield reaction pathways, arrow pushing guide, and NMR/IR spectral breakdown.',
    category: 'Chemistry & Bio',
    university: 'Harvard Pre-Med',
    downloads: '940',
    rating: '4.8',
    author: 'David Kim',
...
const CATEGORIES = [
  { name: 'Computer Science', count: '1,240 Notes', icon: '💻', href: '/study?cat=Computer Science' },
  { name: 'Artificial Intelligence', count: '850 Notes', icon: '🧠', href: '/study?cat=Artificial Intelligence' },
  { name: 'Engineering', count: '920 Notes', icon: '⚡', href: '/study?cat=Engineering' },
  { name: 'Medicine & Bio', count: '640 Notes', icon: '🧬', href: '/study?cat=Medicine' },
  { name: 'Business & Finance', count: '780 Notes', icon: '📈', href: '/study?cat=Business' },
  { name: 'Mathematics', count: '510 Notes', icon: '📐', href: '/study?cat=Mathematics' },
];
